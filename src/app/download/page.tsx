...
import { faApple, faGooglePlay, faGithub, faWindows, faChrome } from "@fortawesome/free-brands-svg-icons";
...
const DownloadPage = () => {
    ...
    const DOWNLOAD_LINKS = [
        ...
        { href: "https://github.com/AsafMeizner/MAshkif/releases/tag/v0.5.0", icon: faGithub, text: "GitHub (windows & android)" },
        { href: "https://www.microsoft.com/store", icon: faWindows, text: "Microsoft Store" },
        { href: "https://mashkif.live", icon: faChrome, text: "Try Without Downloading" },
    ];
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-16">
                {DOWNLOAD_LINKS.map(({ href, icon, text }) => (
                    <a
                        ...
                        className="bg-[#1a1e24] w-[250px] px-8 py-4 rounded-md flex items-center justify-center hover:bg-[#2c3137] transition"
                    >
